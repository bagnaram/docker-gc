...
* [Usage](#usage)
  ...
  * [Running in OpenShift Container Platform](#running-in-openshift)
...
### Specifying Cleanup Interval
You can specify the interval in seconds, which the cleanup should
run. By nature, the docker-gc script will run indefinately and
...
```
$ oc project default
$ oc create imagestream docker-gc
